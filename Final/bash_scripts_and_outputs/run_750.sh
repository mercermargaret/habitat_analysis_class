#!/bin/bash
#SBATCH --job-name=750         # name of the job (make it short!)
...
#SBATCH --array=0-9%10    	       # set number of total simulations and number that can run simultaneously

ml R gdal/3.8.5

cd /home/u15/mmercer3/proj/habitat_analysis_class   # where executable and data is located

list=(/home/u15/mmercer3/proj/habitat_analysis_class/Final/Model_Fit_Results/roads_750/*Rda)

date
echo "Initiating script"

Rscript Final/scripts/analysis_750.R ${list[SLURM_ARRAY_TASK_ID]} # name of script
